...
After first launching psql, you may check the details of your connection by typing
...
```bash
# create database named foo.
CREATE DATABASE foo;
```

After the new “foo” database is created, connect to it.
...
## Display a certain column from a table
